    ...
    <>
      <div className="flex justify-center absolute bottom-0 w-screen my-5">
        ...
        >
          <motion.div
            ...
            variants={variants}
            className="flex items-center gap-1 py-2 px-4 font-medium bg-gray-900 bg-opacity-40 rounded-full
            backdrop-blur-md"
          >
      ...
      <div className="w-screen h-auto min-h-screen flex items-center justify-center flex-col py-16 lg:px-0 px-4">
        <div className="max-w-2xl">
          <h1 className="text-6xl lg:text-7xl font-bold tracking-tight glow-md">alix (｡•̀ᴗ-)✧</h1>
        ...
        <div className="container mx-auto grid grid-cols-3 grid-rows-2 gap-8 m-20 max-w-2xl text-md">
          <div>
            <h1 className="text-neutral-400 mb-3">current</h1>
            <div>
          ...
          <div>
            <h1 className="text-neutral-400 mb-3">other</h1>
            <div className="flex flex-col gap-2">
          ...
          <div>
            <h1 className="text-neutral-400 mb-3">programming languages</h1>
            <div className="flex flex-col gap-2">
        ...
        <div className="mx-auto max-w-2xl">
          <h1 className="mb-3 mt-2 underline decoration-rose-500">network</h1>
